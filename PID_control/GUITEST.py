...
#################################################################################################
    ...
    def setup_gui_env(self):
        ...
        ################################### PID Parameters ##########################################################
        tk.Label(self.SETENV, text="Kp:",font=("Arial", 12)).grid(row=row_idx, column=0,sticky="w",padx=5, pady=5)
        Kp_entry = tk.Entry(self.SETENV, textvariable=self.kp,font=("Arial", 12))
        Kp_entry.grid(row=row_idx, column=1, padx=5, pady=5, sticky="ew")
        row_idx += 1
        

        tk.Label(self.SETENV, text="Ki:",font=("Arial", 12)).grid(row=row_idx, column=0,sticky="w",padx=5, pady=5)
        Ki_entry = tk.Entry(self.SETENV, textvariable=self.ki,font=("Arial", 12))
        Ki_entry.grid(row=row_idx, column=1, padx=5, pady=5, sticky="ew")
        row_idx += 1
    
        tk.Label(self.SETENV, text="Kd:",font=("Arial", 12)).grid(row=row_idx, column=0,sticky="w",padx=5, pady=5)
        Kd_entry = tk.Entry(self.SETENV, textvariable=self.kd,font=("Arial", 12))
        Kd_entry.grid(row=row_idx, column=1, padx=5, pady=5, sticky="ew")
        row_idx += 1

        tk.Label(self.SETENV, text="Max Height of Tank:",font=("Arial", 12)).grid(row=row_idx, column=0, sticky="w",padx=5, pady=5)
        height_entry = tk.Entry(self.SETENV,font=("Arial", 12))
        height_entry.grid(row=row_idx, column=1, padx=5, pady=5, sticky="ew")
        row_idx += 1
        
        self.Episode_var = tk.IntVar(value=1)
        tk.Label(self.SETENV, text = "Episode:",font=("Arial", 12)).grid(row=row_idx, column=0, sticky="w")
        self.Episode_entry = tk.Entry(self.SETENV, font=("Arial", 12), textvariable=self.Episode_var)
